...
uv = 110;
un= 30;
dcArrayDR = [-uv -un-1 -un 0 un un+1 uv];
wArrayDR  = [-Vmax, -Vmin, -Vmin/100, 0,   Vmin/100, Vmin, Vmax]./rNominal;
%%

%%
%%%%%%%%%%%%%%%%%%% control parameter %%%%%%%%%%%%%%%%%%%%%%%%%%%
KP1=8; %20;    % 1 is velocity controller
KP2=20;%20;%10;  %7 ->   % 2 is angle controller
KI1=0.01;%0.3; %0.001; %0.001;%10;
KI2=0.01; %0.001; %0.001;%1; % 3 ->
KD1=0; %3; %0; %3; %0;%3;
KD2=2;% 3;%  %.5; %0; %0.5; %0;%0.5; %0.5 ->
...
Vcom = 1.5;%3*VmaxDR/4; % [m/s] used when constant speed is commanded
